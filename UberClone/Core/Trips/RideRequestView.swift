...
struct RideRequestView: View {
    ...
    var body: some View {
        VStack{
            ...
            HStack(spacing: 12){
                Text("Visa")
                    .font(.subheadline).fontWeight(.semibold).padding(6).background(.blue).cornerRadius(4).foregroundColor(.white).padding(.leading)
                Text("**** 2901").fontWeight(.bold)
        ...
        .padding(.bottom, 24)
        .background(Color.theme.backgroundColor).cornerRadius(16)
    }
}
